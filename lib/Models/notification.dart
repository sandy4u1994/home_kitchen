...
class NotificationList {
  ...
  NotificationList() {
    this._notifications = [
      new Notification(
          'assets/img/food1.jpg', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry', '33min ago'),
      new Notification('assets/img/food2.jpg', 'It is a long established fact that a reader will be distracted', '32min ago'),
      new Notification('assets/img/user3.jpg', 'There are many variations of passages of Lorem Ipsum available', '34min ago'),
      new Notification(
      ...
      new Notification(
          'assets/img/user1.jpg', 'Contrary to popular belief, Lorem Ipsum is not simply random text', '1 day ago'),
    ];
  }
